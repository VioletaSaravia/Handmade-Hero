/*
    ...
    OpenGL loader generated by glad 0.1.36 on Fri Apr 11 12:59:23 2025.
...
static void *Win32_GetProcAddress(const char *namez);
...
int gladLoadGL(void) {
    ...
    if (open_gl()) {
        status = gladLoadGLLoader(&Win32_GetProcAddress);
        close_gl();
    }
