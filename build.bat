...
set WIN_LIBS=User32.lib Gdi32.lib Winmm.lib opengl32.lib xinput.lib SDL3.lib SDL3_image.lib SDL3_ttf.lib
set VENDOR_UNITS=vendor\\glad.c vendor\\stb_image.c
...
if /i "%build%"=="clean" (
    ...
    %CL_DEBUG% %INCLUDES% /link %LIBS% /INCREMENTAL:NO build\\debug\\glad.obj build\\debug\\stb_image.obj %WIN_LIBS% /PDB:build\\debug\\game%TIMESTAMP%.pdb /DLL /NOEXP
)